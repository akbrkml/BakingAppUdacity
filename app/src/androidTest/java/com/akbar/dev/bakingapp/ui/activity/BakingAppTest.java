...
public class BakingAppTest {
    ...
    public void bakingAppTest() {
        ...
        ViewInteraction appCompatImageButton3 = onView(
                allOf(withId(R.id.play), withContentDescription("Pause"), isDisplayed()));
        appCompatImageButton3.perform(click());

        ViewInteraction appCompatImageButton4 = onView(
                allOf(withId(R.id.rew), withContentDescription("Rewind"), isDisplayed()));
        ...
        ViewInteraction appCompatImageButton5 = onView(
                allOf(withId(R.id.play), withContentDescription("Play"), isDisplayed()));
        ...
        ViewInteraction appCompatImageButton6 = onView(
                allOf(withId(R.id.prev), withContentDescription("Previous track"), isDisplayed()));
